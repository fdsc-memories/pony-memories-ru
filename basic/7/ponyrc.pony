...
Viewpoints (точка зрения на объект в зависимости от ссылочных способностей) всегда не видят то, что нарушает целостность
...
Как поле ref передаётся в box и что получается с оставшимся ref (box - неизменяемый и непосылаемый)
